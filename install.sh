...
then
mkdir /etc/blocker
echo blocker directory created >> /etc/blocker/blocker-log.txt
fi
...
echo blocker subdirectory countries created >> /etc/blocker/blocker-log.txt
fi
...
echo all zone file downloaded >> /etc/blocker/blocker-log.txt
fi
...
echo blocker saubdirectory country zones created >> /etc/blocker/blocker-log.txt
fi
...
echo unpack all zones file >> /etc/blocker/blocker-log.txt
...
echo add established connection accept >> /etc/blocker/blocker-log.txt
fi
...
echo create blocker-white chain >> /etc/blocker/blocker-log.txt
fi
...
echo create blocker-scan chain >> /etc/blocker/blocker-log.txt
fi
...
echo create blocker-geo chain >> /etc/blocker/blocker-log.txt
fi
...
echo create filter and return ruled >> /etc/blocker/blocker-log.txt
fi


#create logfile
echo blocker succsessfully installed >> /etc/blocker/blocker-log.txt
